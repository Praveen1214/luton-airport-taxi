      ...
      <div className="w-full bg-gradient from-blue-50 to-transparent">
          ...
          <div className="flex flex-col items-start justify-between md:flex-row">
            {quoteStep === 1 && (
              <div className="w-full md:mr-12">
                <Hero
                  name="Assisted Passengers Transport"
                  description1="Save Up to 40% By Pre‑Booking Your Luton"
                  description2="Assisted Passengers Transport With Us"
                />
              </div>
            )}
        ...
        {quoteStep === 1 && (
          <>
            ...
            <div className="mt-10">
              <Section
                t1="Assisted Passengers Transport "
                t2="WheelChair Passangers"
                t3="Ongoing Assisted Travel"
