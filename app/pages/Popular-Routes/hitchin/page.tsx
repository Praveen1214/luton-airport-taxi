      ...
      <section className="w-full px-4 py-8 text-center md:py-20 bg-gradient from-blue-50 to-transparent">
        <div className="max-w-6xl mx-auto ">
          ...
          <p className="max-w-xl mx-auto mb-6 text-sm text-gray-700 sm:text-base">
            Save Up to 40 % By Pre Booking Your Hitchin Airport Transfer With Us
          </p>
          ...
          <div className="flex flex-col items-start justify-between gap-6 md:flex-row sm:gap-8">
            ...
            <div className="w-full md:w-2/3">
              <h2 className="mb-4 text-xl font-semibold text-gray-900 sm:text-2xl md:text-3xl">
                Hitchin to Luton Airport Taxi Time Interval
              </h2>
              <p className="mb-4 text-sm leading-relaxed text-justify text-gray-700 sm:text-base">
                With our Hitchin to Luton Airport taxi, you can reach to the
              ...
              <p className="text-sm leading-relaxed text-justify text-gray-700 sm:text-base">
                The interval from Hitchin to Luton Town via taxi or your own car
                is approximately 29 minutes.The distance between Luton and
                Hitchin is approximately 22.5 miles which are equal to 36.2
        ...
        <section className="max-w-6xl px-4 py-8 mx-auto sm:py-12 md:py-16">
          <div className="max-w-6xl mx-auto space-y-4 sm:space-y-6">
            ...
            {/* Paragraphs */}
            <p className="text-sm leading-relaxed text-justify text-gray-700 sm:text-base">
              There are many ways to travel to Hitchin from Luton.Such as Local
              bus, Coach and Train.But Hitchin to or from Luton airport taxi is
            ...
            <p className="text-sm text-justify text-gray-700 sm:text-base">
              Some people use the Luton airport taxi to Hitchin but some others
            ...
            <div className="px-4 py-4 text-xs leading-relaxed text-justify text-gray-700 bg-gray-100 rounded-lg sm:px-6 sm:py-5 sm:text-sm">
              <ol className="space-y-2 list-decimal list-inside">
                ...
                <li>
                  ...
                  Luton airport taxi to Hitchin
                </li>
                <li>Get off at Central Railway Station MK9 1LA of Hitchin</li>
              </ol>
            </div>
            <div className="flex items-start gap-2 p-3 text-xs rounded-md text-primary sm:text-sm bg-blue-50 rounded-tl-xl">
              ...
              <p>Every 15 - 30 minutes a train leaves to Hitchin from Luton</p>
            </div>
          </div>
        </section>
