  ...
  return (
    <main className="flex flex-col w-full">
      ...
      {quoteStep === 1 && (
        <>
          {/* Hero Section */}
          <section className="w-full px-4 py-8 text-center mt-60 md:py-20 bg-gradient from-blue-50 to-transparent md:-mt-16">
              ...
              <div className="flex flex-col items-start justify-between gap-6 md:flex-row sm:gap-8">
                ...
                <div className="w-full md:w-2/3">
                  ...
                  <p className="mb-4 text-sm leading-relaxed text-justify text-gray-700 sm:text-base">
                    With our Aylesbury to Luton Airport taxi, you can reach to
                  ...
                  <p className="text-sm leading-relaxed text-justify text-gray-700 sm:text-base">
                    The interval from Aylesbury to Luton Town via taxi or your
                    own car is approximately 29 minutes.The distance between
                    Luton and Aylesbury is approximately 22.5 miles which are
              ...
              <div className="flex flex-col-reverse items-start justify-between gap-6 md:flex-row sm:gap-8">
                ...
                <div className="w-full md:w-2/3">
                  ...
                  <p className="mb-4 text-sm leading-relaxed text-justify text-gray-700 sm:text-base">
                    ...
                    as Bedfordshire and Aylesbury.Our Aylesbury to Luton airport
                  ...
                  <p className="text-sm leading-relaxed text-justify text-gray-700 sm:text-base">
                    ...
                    and connected to the satellite system.Our Aylesbury to Luton
                    ...
                    Aylesbury to Luton airport taxi with us now to save your
                    time and money.
                  </p>
                </div>
              </div>
            ...
            <section className="max-w-6xl px-4 py-8 mx-auto sm:py-12 md:py-16">
              <div className="max-w-6xl mx-auto space-y-4 sm:space-y-6">
                ...
                <p className="text-sm leading-relaxed text-justify text-gray-700 sm:text-base">
                  ...
                  Local bus, Coach and Train.But Aylesbury to or from Luton
                ...
                <p className="text-sm text-justify text-gray-700 sm:text-base">
                  ...
                  can travel to Aylesbury by train
                </p>
                <div className="px-4 py-4 text-xs leading-relaxed text-justify text-gray-700 bg-gray-100 rounded-lg sm:px-6 sm:py-5 sm:text-sm">
                  <ol className="space-y-2 list-decimal list-inside">
                    ...
                    <li>
                      ...
                      with Luton airport taxi to Aylesbury
                    </li>
                    <li>
                      Get off at Central Railway Station MK9 1LA of Aylesbury
                    </li>
                  </ol>
                </div>
