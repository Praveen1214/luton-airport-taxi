  ...
  return (
    ...
    >
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div className="p-4 md:p-6 md:grid md:grid-cols-[2fr_1.5fr] md:gap-8 relative">
          {/* A vertical “divider” in the middle (optional dashed style) */}
          <div className="hidden md:block absolute left-2.5/4 top-0 h-full w-px bg-gray-100 -translate-x-1/2" />
          ...
          <div className="mb-6 md:mb-0 md:pr-8">
            ...
            {/* Date & Time */}
            <div className="flex items-end space-x-10 mb-6 gap-10">
              <div>
              ...
              <div className="flex flex-row items-center space-x-40 mb-6 border-t border-gray-100 pt-4">
            {/* Pickup & Drop-off */}
            <div className="mb-6">
              ...
              <div className="flex items-start">
                ...
                <div className="flex flex-col items-center mr-3">
                  <div className="w-3 h-3 rounded-full border-2 border-blue-600 flex items-center justify-center">
                    <div className="w-1.0 h-1.5 bg-blue-600 rounded-full"></div>
                  </div>
    ...
    <div className="bg-gray-900 text-white w-full p-4 rounded flex justify-between items-center ">
      ...
      <div className="flex flex-col items-end">
        ...
        <div className="flex items-center mb-2">
          ...
          <span className="text-xs text-gray-300">
            01582 262006 | 00441582 292929 (Outside UK)
          </span>
        </div>
